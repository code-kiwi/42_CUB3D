...
/*   Updated: 2024/07/22 12:36:27 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	revenant_projectile_use(t_game *game, t_bullet *bullet)
{
	...
	sprite->animation = &game->animations[IDX_TXTR_REV_PROJ_DEATH];
...
void	revenant_projectile_init(t_animation animations[MAP_NB_IDS], t_bullet *bullet)
{
	t_sprite_init(bullet->sprite, &animations[IDX_TXTR_REV_PROJ_LIVE], WIN_HEIGHT);
