...
static void	revenant_projectile_use(t_game *game, t_bullet *bullet)
{
	...
	sprite->animation = game->textures[IDX_TXTR_REV_PROJ_DEATH];
...
void	revenant_projectile_init(t_list *textures[MAP_NB_IDS], t_bullet *bullet)
{
	t_sprite_init(bullet->sprite, textures[IDX_TXTR_REV_PROJ_LIVE], WIN_HEIGHT);
