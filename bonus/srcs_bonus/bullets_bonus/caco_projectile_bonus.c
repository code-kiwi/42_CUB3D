...
/*   Updated: 2024/07/23 10:52:52 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	caco_projectile_use(t_game *game, t_bullet *bullet)
{
	...
	sprite->animation = &game->animations[IDX_TXTR_CACO_PROJ_DEATH];
...
{
	t_sprite_init(bullet->sprite, &animations[IDX_TXTR_CACO_PROJ_LIVE], WIN_HEIGHT);
