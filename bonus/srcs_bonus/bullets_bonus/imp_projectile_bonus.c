...
/*   Updated: 2024/07/23 10:53:09 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	imp_projectile_use(t_game *game, t_bullet *bullet)
{
	...
	sprite->animation = &game->animations[IDX_TXTR_IMP_PROJ_DEATH];
...
{
	t_sprite_init(bullet->sprite, &animations[IDX_TXTR_IMP_PROJ_LIVE], WIN_HEIGHT);
