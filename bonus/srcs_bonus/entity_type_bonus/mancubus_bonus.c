...
/*   Updated: 2024/07/23 13:19:55 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	mancubus_get_killed(t_game *game, t_entity *entity)
{
	...
	set_animation(entity->sprite, &game->anim[IDX_TXTR_MANCUBUS_DEATH]);
...
{
	set_animation(entity->sprite, &game->anim[IDX_TXTR_MANCUBUS_PAIN]);
