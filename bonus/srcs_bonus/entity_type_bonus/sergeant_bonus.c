...
/*   Updated: 2024/07/23 13:20:01 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	sergeant_get_killed(t_game *game, t_entity *entity)
{
	...
	set_animation(entity->sprite, &game->anim[IDX_TXTR_SERGEANT_DEATH]);
...
{
	set_animation(entity->sprite, &game->anim[IDX_TXTR_SERGEANT_PAIN]);
