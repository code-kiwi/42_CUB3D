...
/*   Updated: 2024/07/22 14:44:12 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	cyber_get_killed(t_game *game, t_entity *entity)
{
	...
	entity->sprite->animation = game->textures[IDX_TXTR_CYBER_DEATH];
...
{
	entity->sprite->next_animation = game->textures[IDX_TXTR_CYBER_WALK];
	entity->sprite->animation = game->textures[IDX_TXTR_CYBER_PAIN];
...
bool	cyber_init(t_entity *entity, t_list *textures[MAP_NB_IDS])
{
	...
	entity->type = NULL;
	t_sprite_init(entity->sprite, textures[IDX_TXTR_CYBER_WALK], WIN_HEIGHT);
	return (true);
}
