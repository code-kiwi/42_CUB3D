...
/*   Updated: 2024/07/23 11:18:48 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	pain_elem_get_killed(t_game *game, t_entity *entity)
{
	...
	entity->sprite->animation = &game->anim[IDX_TXTR_PAIN_ELEM_DEATH];
...
static bool	pain_elem_get_damage(t_game *game, t_entity *entity, size_t damage)
{
	...
	entity->sprite->animation = &game->anim[IDX_TXTR_PAIN_ELEM_PAIN];
