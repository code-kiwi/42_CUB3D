...
/*   Updated: 2024/07/23 11:16:25 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	commando_get_killed(t_game *game, t_entity *entity)
{
	...
	entity->sprite->animation = &game->anim[IDX_TXTR_COMMANDO_DEATH];
...
static bool	commando_get_damage(t_game *game, t_entity *entity, size_t damage)
{
	...
	entity->sprite->animation = &game->anim[IDX_TXTR_COMMANDO_PAIN];
