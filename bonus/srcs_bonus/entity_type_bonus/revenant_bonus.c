...
/*   Updated: 2024/07/23 12:13:53 by brappo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	revenant_get_killed(t_game *game, t_entity *entity)
{
	...
	entity->sprite->animation = &game->anim[IDX_TXTR_REVENANT_DEATH];
...
static bool	revenant_get_damage(t_game *game, t_entity *entity, size_t damage)
{
	...
	entity->sprite->animation = &game->anim[IDX_TXTR_REVENANT_PAIN];
	entity->sprite->texture = entity->sprite->animation->textures;
